      ...
      <div class="row container ftco-animate">
        ...
        <div class="col-md-4 mt-4">
            <div class="container card card-product" style="width: 18rem;">
              <img src="{{ asset('img_souvenir/slide1') }}/{{ $item['gambar1'] }}" class="card-img-top mt-2" alt="...">
                  ...
                  <div id="carouselExampleIndicators{{ $item['id'] }}" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" id="hotel-carousel">
                      <div class="carousel-item active">
                        <a href="{{ asset('img_souvenir/slide1') }}/{{ $item['gambar1'] }}" class="insta-img image-popup" style="background-image: url(images/insta-1.jpg);">
                        <img src="{{ asset('img_souvenir/slide1') }}/{{ $item['gambar1'] }}" class="d-block w-50" alt=""></a>
                      </div>
                      <div class="carousel-item">
                        <a href="{{ asset('img_souvenir/slide2') }}/{{ $item['gambar2'] }}" class="insta-img image-popup" style="background-image: url(images/insta-1.jpg);">
                        <img src="{{ asset('img_souvenir/slide2') }}/{{ $item['gambar2'] }}" class="d-block w-50" alt=""></a>
                      </div>
                      <div class="carousel-item">
                        <a href="{{ asset('img_souvenir/slide3') }}/{{ $item['gambar3'] }}" class="insta-img image-popup" style="background-image: url(images/insta-1.jpg);">
