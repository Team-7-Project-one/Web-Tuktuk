...
<html lang="en">
  ...
  <div style="background-image: url('img/aboutus/bg_about.jpg'); background-size: cover; background-position: center center;">
      <br><br><br>
    <h1 class="text-center pb-5 text-light">KELOMPOK 7 - IT DEL</h1><br>
    <center>
