    ...
    @endif
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $item['harga'] }}</td>
          <td>
            <button href="" class="btn btn-success btn-sm rounded-pill" data-bs-toggle="modal" data-bs-target="#abc{{ $item['id'] }}" ><i class="fas fa-info-circle"></i> Detail</button>
            <a href="/dashboard/souvenir/ubah/{{ $item['id'] }}" class="btn btn-warning btn-sm rounded-pill" ><i class="fas fa-edit"></i> Ubah</a>
            <a href="/dashboard/souvenir/hapus/{{ $item['id'] }}" class="btn btn-danger btn-sm rounded-pill"><i class="fas fa-trash"></i> Hapus</a>
          </td>
        </tr>
        <?php $i++; ?>
        @endforeach
                  ...
                  <div id="carouselExampleIndicators{{ $item['id'] }}" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" id="hotel-carousel">
                      <div class="carousel-item active">
                        <a href="{{asset('img_souvenir/slide1')}}/{{ $item->gambar1 }}" class="insta-img image-popup">
                        <img src="{{asset('img_souvenir/slide1')}}/{{ $item->gambar1 }}" class="d-block w-50" alt=""></a>
                      </div>
                      <div class="carousel-item">
                        <a href="{{asset('img_souvenir/slide2')}}/{{ $item->gambar2 }}" class="insta-img image-popup">
                        <img src="{{asset('img_souvenir/slide2')}}/{{ $item->gambar2 }}" class="d-block w-50" alt=""></a>
                      </div>
                      <div class="carousel-item">
                        <a href="{{asset('img_souvenir/slide3')}}/{{ $item->gambar3 }}" class="insta-img image-popup">
                        <img src="{{asset('img_souvenir/slide3')}}/{{ $item->gambar3 }}" class="d-block w-50" alt="">
                        </a>
                      </div>
                    </div>
