...
<html lang="en">
  ...
  <body>
      ...
      <form class="container" enctype="multipart/form-data" action="/dashboard/souvenir/simpan" method="post">
        {{ csrf_field() }}
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <input type="text" name="nama_souvenir" class="form-control">
            @error('nama_souvenir')
          ...
          <div class="col-md-6">
            <label for="">Kontak <span class="text-muted text-sm">| Contoh inputan : 6289768328245</span></label>
            <input type="text" name="kontak" value="62" class="form-control">
            @error('kontak')
            <b class="text-danger"><i class="fas fa-exclamation-circle"></i> {{$message}}</b>
          @enderror
          </div>
